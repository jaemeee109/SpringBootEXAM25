...
import org.exam.board.domain.BoardImage;
...
public class BoardRepositoryTests {
    ...
    public void testInsertWithImage(){
        ...
        Board board = Board.builder()
                .title("testInsertWithImage:이미지테스트")
                .content("testInsertWithImage:첨부파일테스트")
                .writer("testInsertWithImage:tester")
                .build();
    ...
    @Test
    public void testReadWithImageEntityGraph(){
    ...
    }//testReadWithImageEntityGraph 종료
